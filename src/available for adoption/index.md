...
<body>
  ...
  <div class="container">
    <!-- Fletcher -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Fletcher" alt="Fletcher">
      <h2>Fletcher</h2>
    ...
    <!-- Pudge -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Pudge" alt="Pudge">
      <h2>Pudge</h2>
    ...
    <!-- Max -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Max" alt="Max">
      <h2>Max</h2>
    ...
    <!-- Luna -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Luna" alt="Luna">
      <h2>Luna</h2>
    ...
    <!-- Bella -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Bella" alt="Bella">
      <h2>Bella</h2>
    ...
    <!-- Oliver -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Oliver" alt="Oliver">
      <h2>Oliver</h2>
    ...
    <!-- Rocky -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Rocky" alt="Rocky">
      <h2>Rocky</h2>
    ...
    <!-- Daisy -->
    <div class="card">
      <img src="https://via.placeholder.com/300x200?text=Daisy" alt="Daisy">
      <h2>Daisy</h2>
